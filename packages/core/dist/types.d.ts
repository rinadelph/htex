...
export type ASTNode = CommandNode | EnvironmentNode | TextASTNode | MathASTNode | GroupASTNode | CommentASTNode | VerbatimASTNode;
...
export interface ConvertOptions extends Partial<ParseOptions>, Partial<TransformOptions>, Partial<MeasureOptions>, Partial<RenderOptions> {
}
export declare class HtexError extends Error {
    readonly context?: string | undefined;
    readonly name: string;
    constructor(message: string, context?: string | undefined);
}
export declare class ParseError extends HtexError {
    readonly line: number;
    readonly col: number;
    readonly name = "ParseError";
    constructor(message: string, line: number, col: number, context?: string);
}
export declare class TransformError extends HtexError {
    readonly nodeType?: string | undefined;
    readonly name = "TransformError";
    constructor(message: string, nodeType?: string | undefined, context?: string);
}
export declare class MeasureError extends HtexError {
    readonly font?: string | undefined;
    readonly name = "MeasureError";
    constructor(message: string, font?: string | undefined, context?: string);
}
export declare class RenderError extends HtexError {
    readonly renderTarget?: string | undefined;
    readonly name = "RenderError";
    constructor(message: string, renderTarget?: string | undefined, context?: string);
}
export {};
